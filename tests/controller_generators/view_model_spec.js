...
t.describe('Controllers::ViewModel', () => {
  const loadFile = (() => fs.readFileSync(file));
  let file = null;

  t.describe('piyopiyo', () => {
    t.beforeEach(() => {
      file = path.resolve(__dirname, '../', '../', 'tmp', 'app', 'view_models', 'controllers', 'piyopiyo.js');
    });
  ...
  t.describe('hoges/fuga', () => {
    t.beforeEach(() => {
      file = path.resolve(__dirname, '../', '../', 'tmp', 'app', 'view_models', 'controllers', 'hoges', 'fuga.js');
    });
  ...
  t.describe('hoges/fugas/foo', () => {
    t.beforeEach(() => {
      file = path.resolve(__dirname, '../', '../', 'tmp', 'app', 'view_models', 'controllers', 'hoges', 'fugas', 'foo.js');
    });
