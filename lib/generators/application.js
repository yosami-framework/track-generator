...
module.exports = function(plop) {
  plop.setGenerator('application', {
    ...
    prompts:     [{
      ...
      type:    'input',
      name:    'versionMithril',
      message: 'Input mithril version',
    }, {
      type:    'input',
      name:    'versionTrackPackages',
      message: 'Input track-packages version',
    }, {
      type:    'input',
      name:    'versionTrackGenerator',
      message: 'Input track-generator version',
    }],
    actions: [{
      type:         'add',
      ...
      const packages = [
        `mithril@${prompts.versionMithril}`,
        `track-packages@${prompts.versionTrackPackages}`,
        'track-server-cache-lru-cache',
        'track-server-middleware-fastify',
      ].join(' ');
      const devPackages = [
        `track-generator@${prompts.versionTrackGenerator}`,
        'track-spec',
      ].join(' ');
